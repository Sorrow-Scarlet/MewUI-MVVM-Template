...
public class NativeCustomWindow : Window
{
            ...
            new StateTrigger
            {
                ...
                [
                    Setter.Create(
                        ...
                        t => t.Palette.ButtonPressedBackground
                    ),
                ],
            },
        ],
    ...
    public NativeCustomWindow()
    {
        ...
        var maxGlyph = new GlyphElement()
            .Kind(GlyphKind.WindowMaximize)
            .GlyphSize(ChromeButtonSize);
        ...
        this._titleBar = new AlphaTextPanel
        {
        ...
        {
            BorderThickness = 0,
            Child = new DockPanel().Children(_titleBar.DockTop(), _contentArea),
        };
